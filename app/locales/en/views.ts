export default {
    ...
    contact: {
        ...
        description2:
            'We are always happy to hear from you. Please feel free to contact us with any questions or concerns you may have.',
        form: {
            name: 'Name',
            email: 'Email',
            message: 'Message',
    ...
    auth: {
        register: {
            ...
            helpText: 'Enter your email below to create your account',
            byClicking: 'By clicking Sign Up, you agree to our',
    ...
    EnhancedProfilePage: {
        ...
        subscriptionDetailsDesc: 'Manage your subscription and billing',
        nextBilling: 'Next billing date:',
        transactionHistory: 'Transaction History',
        transactionHistoryDesc: 'View your past transactions',
        transaction: 'Transaction',
        learningActivity: 'Learning Activity',
        learningActivityDesc: 'Track your progress and achievements',
        profileSettings: 'Profile Settings',
        profileSettingsDesc: 'Manage your account preferences',
        account: 'Account',
        ...
        languageRegionDesc: 'Set your language preferences',
        change: 'Change',
        loading: 'Loading...',
